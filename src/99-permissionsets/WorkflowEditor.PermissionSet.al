permissionset 83800 "Workflow Editor WFE"
{
    ...
    Permissions =
        ...
        table "Approver Tree WFE" = X,
        tabledata "Approver Tree WFE" = RIMD,
        table "Info Dialog WFE" = X,
        tabledata "Info Dialog WFE" = RIMD,
        table "Instances Per Workflow WFE" = X,
        tabledata "Instances Per Workflow WFE" = RIMD,
        ...
        table "Workflow Tree WFE" = X,
        tabledata "Workflow Tree WFE" = RIMD,
        ...
        codeunit "Approver Tree Helper WFE" = X,
        codeunit "Approver Tree WFE" = X,
        codeunit "Create Workflow File Tree WFE" = X,
        codeunit "Create Workflow Tree WFE" = X,
        ...
        codeunit "Instances Per Workflow Hlp WFE" = X,
        ...
        codeunit "Workflow Tree Hlp WFE" = X,
        codeunit "XML Buffer Helper WFE" = X,
        page "App Resource List WFE" = X,
        page "Approval Entries WFE" = X,
        page "Approval Entry Part WFE" = X,
        page "Approver Tree WFE" = X,
        page "Info Dialog WFE" = X,
        page "Instances Per Workflow WFE" = X,
        ...
        page "Workflow Step Arguments WFE" = X,
